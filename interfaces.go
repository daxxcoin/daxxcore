...
// Package daxxcoin defines interfaces for interacting with Daxxcoin.
package daxxcoin
...
type CallMsg struct {
	...
	GasPrice *big.Int        // dei<-> gas exchange ratio
	Value    *big.Int        // amount of deisent along with the call
