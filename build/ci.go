...
import (
	...
	"github.com/daxxcoin/daxxcore/internal/build"
)
...
var (
	...
	debExecutables = []debExecutable{
		{
			Name:        "geth",
			Description: "Daxxcoin CLI client.",
		},
		{
			Name:        "rlpdump",
		...
		{
			Name:        "evm",
			Description: "Developer utility version of the EVM (Daxxcoin Virtual Machine) that is capable of running bytecode snippets within a configurable environment and execution mode.",
		},
		{
			Name:        "swarm",
			Description: "Daxxcoin Swarm daemon and tools",
		},
		{
			Name:        "abigen",
			Description: "Source code generator to convert Daxxcoin contract definitions into easy to use, compile-time type-safe Go packages.",
		},
	}
...
func doInstall(cmdline []string) {
	...
	if runtime.Version() < "go1.4" && !strings.HasPrefix(runtime.Version(), "devel") {
		...
		log.Println("daxxcorerequires at least Go version 1.4 and cannot")
...
func doDebianSource(cmdline []string) {
	var (
		...
		upload  = flag.String("upload", "", `Where to upload the source package (usually "ppa:daxxcoin/daxxcoin")`)
...
type debMetadata struct {
	...
	// daxxcoreversion being built. Note that this
...
func newDebMetadata(distro, author string, env build.Environment, t time.Time) debMetadata {
	if author == "" {
		...
		author = "Daxxcoin Builds <fjl@daxxcoin.org>"
	}
	return debMetadata{
		Env:         env,
		Author:      author,
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "--target", "android", "--javapkg", "org.daxxcoin", "-v", "github.com/daxxcoin/daxxcore/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "--target", "ios", "--tags", "ios", "-v", "github.com/daxxcoin/daxxcore/mobile")
