...
// PublicDaxxcoinAPI provides an API to access Daxxcoin full node-related
// information.
...
func (s *PrivateMinerAPI) SetDaxxcoinbase(daxxcoinbase common.Address) bool {
	s.e.SetDaxxcoinbase(daxxcoinbase)
	return true
}
...
// PrivateAdminAPI is the collection of Daxxcoin full node-related APIs
...
// admin methods of the Daxxcoin service.
...
// PublicDebugAPI is the collection of Daxxcoin full node APIs exposed
...
// related public debug methods of the Daxxcoin service.
...
// PrivateDebugAPI is the collection of Daxxcoin full node APIs exposed over
...
// private debug methods of the Daxxcoin service.
