...
import (
	...
	"github.com/daxxcoin/daxxcore/miner"
...
type Daxxcoin struct {
	...
	shutdownChan  chan bool // Channel for shutting down the daxxcoin
...
// New creates a new Daxxcoin object (including the
// initialisation of the common Daxxcoin object)
func New(ctx *node.ServiceContext, config *Config) (*Daxxcoin, error) {
	...
	eth := &Daxxcoin{
		...
		daxxcoinbase:      config.Daxxcoinbase,
	...
	if genesis == nil {
		...
		glog.V(logger.Info).Infoln("WARNING: Wrote default daxxcoin genesis block")
	}
	...
	return append(ethapi.GetAPIs(s.ApiBackend, s.solcPath), []rpc.API{
		{
			Namespace: "eth",
			Version:   "1.0",
			Service:   NewPublicDaxxcoinAPI(s),
			Public:    true,
		}, {
			Namespace: "eth",
			Version:   "1.0",
...
func (s *Daxxcoin) Daxxcoinbase() (eb common.Address, err error) {
	if s.daxxcoinbase != (common.Address{}) {
		return s.daxxcoinbase, nil
	}
	...
	return common.Address{}, fmt.Errorf("daxxcoinbase address must be explicitly specified")
}

// set in js console via admin interface or wrapper from cli flags
func (self *Daxxcoin) SetDaxxcoinbase(daxxcoinbase common.Address) {
	self.daxxcoinbase = daxxcoinbase
	self.miner.SetDaxxcoinbase(daxxcoinbase)
}

func (s *Daxxcoin) StartMining(threads int) error {
	eb, err := s.Daxxcoinbase()
	if err != nil {
		err = fmt.Errorf("Cannot start mining without daxxcoinbase address: %v", err)
...
func (s *Daxxcoin) StopMining()         { s.miner.Stop() }
func (s *Daxxcoin) IsMining() bool      { return s.miner.Mining() }
func (s *Daxxcoin) Miner() *miner.Miner { return s.miner }

func (s *Daxxcoin) AccountManager() *accounts.Manager  { return s.accountManager }
func (s *Daxxcoin) BlockChain() *core.BlockChain       { return s.blockchain }
func (s *Daxxcoin) TxPool() *core.TxPool               { return s.txPool }
func (s *Daxxcoin) EventMux() *event.TypeMux           { return s.eventMux }
func (s *Daxxcoin) Pow() pow.PoW                       { return s.pow }
func (s *Daxxcoin) ChainDb() ethdb.Database            { return s.chainDb }
func (s *Daxxcoin) IsListening() bool                  { return true } // Always listening
func (s *Daxxcoin) EthVersion() int                    { return int(s.protocolManager.SubProtocols[0].Version) }
func (s *Daxxcoin) NetVersion() int                    { return s.netVersionId }
func (s *Daxxcoin) Downloader() *downloader.Downloader { return s.protocolManager.downloader }
