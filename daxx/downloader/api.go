...
// Syncing provides information when this nodes starts synchronising with the Daxxcoin network and when it's finished.
...
type SyncingResult struct {
	...
	Status  daxxcoin.SyncProgress `json:"status"`
}
