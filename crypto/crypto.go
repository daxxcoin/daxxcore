...
import (
	...
	"github.com/daxxcoin/daxxcore/crypto/ecies"
	"github.com/daxxcoin/daxxcore/crypto/secp256k1"
	"github.com/daxxcoin/daxxcore/crypto/sha3"
...
// Creates an daxxcoin address given the bytes and the nonce
...
//
// Note: secp256k1 expects the recover id to be either 0, 1. Daxxcoin
// signatures have a recover id with an offset of 27. Callers must take
// this into account and if "recovering" from an Daxxcoin signature adjust.
