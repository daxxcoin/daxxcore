...
// Package miner implements Daxxcoin block creation and mining.
package miner
...
func (self *Miner) Start(coinbase common.Address, threads int) {
	atomic.StoreInt32(&self.shouldStart, 1)
	self.worker.setDaxxcoinbase(coinbase)
...
func (self *Miner) SetDaxxcoinbase(addr common.Address) {
	self.coinbase = addr
	self.worker.setDaxxcoinbase(addr)
}
