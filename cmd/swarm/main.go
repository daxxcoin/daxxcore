...
import (
	...
	"github.com/daxxcoin/daxxcore/swarm"
	bzzapi "github.com/daxxcoin/daxxcore/swarm/api"
...
var (
	...
	app              = utils.NewApp(gitCommit, "Daxxcoin Swarm")
...
var (
	...
	EthAPIFlag = cli.StringFlag{
		Name:  "ethapi",
		Usage: "URL of the Daxxcoin API provider",
