...
// geth is the official command-line client for Daxxcoin.
package main
...
import (
	...
	"github.com/daxxcoin/daxxcore/console"
	"github.com/daxxcoin/daxxcore/contracts/release"
	"github.com/daxxcoin/daxxcore/daxx"
	"github.com/daxxcoin/daxxcore/daxxclient"
	"github.com/daxxcoin/daxxcore/internal/debug"
...
var (
	...
	gitCommit = ""
	// Daxxcoin address of the Geth release oracle.
	relOracle = common.HexToAddress("0xfa7b9770ca4cb04296cac84f37736d4041251cdf")
	// The app that holds all commands and flags.
	app = utils.NewApp(gitCommit, "the daxxcorecommand line interface")
)
...
func init() {
	...
	app.Copyright = "Copyright 2013-2016 The daxxcoreAuthors"
...
func makeFullNode(ctx *cli.Context) *node.Node {
	...
	// Add the Daxxcoin Stats daemon if requested
...
func startNode(ctx *cli.Context, stack *node.Node) {
	...
	if ctx.GlobalBool(utils.MiningEnabledFlag.Name) {
		var daxxcoin *eth.Daxxcoin
		if err := stack.Service(&daxxcoin); err != nil {
			utils.Fatalf("daxxcoin service not running: %v", err)
		}
		if err := daxxcoin.StartMining(ctx.GlobalInt(utils.MinerThreadsFlag.Name)); err != nil {
