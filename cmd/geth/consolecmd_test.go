...
func TestIPCAttachWelcome(t *testing.T) {
	...
	geth := runGeth(t,
		"--port", "0", "--maxpeers", "0", "--nodiscover", "--nat", "none",
		"--daxxcoinbase", coinbase, "--shh", "--ipcpath", ipc)
...
func TestHTTPAttachWelcome(t *testing.T) {
	...
	geth := runGeth(t,
		"--port", "0", "--maxpeers", "0", "--nodiscover", "--nat", "none",
		"--daxxcoinbase", coinbase, "--rpc", "--rpcport", port)
...
func TestWSAttachWelcome(t *testing.T) {
	...
	geth := runGeth(t,
		"--port", "0", "--maxpeers", "0", "--nodiscover", "--nat", "none",
		"--daxxcoinbase", coinbase, "--ws", "--wsport", port)
...
func testAttachWelcome(t *testing.T, geth *testgeth, endpoint string) {
	...
	attach.setTemplateFunc("daxxcoinbase", func() string { return geth.Daxxcoinbase })
