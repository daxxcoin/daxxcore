...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Daxxcoin presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    geth wallet import /path/to/my/presale.wallet

will prompt for your password and imports your daxxcoinpresale account.
		...
		Subcommands: []cli.Command{
			{
				Action:    importWallet,
				Name:      "import",
				Usage:     "Import Daxxcoin presale wallet",
				ArgsUsage: "<keyFile>",
				Description: `
...
between daxxcoin nodes by simply copying.
...
Note:
As you can directly copy your encrypted accounts to another daxxcoin instance,
