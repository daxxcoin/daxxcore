...
// Package ethclient provides a client for the Daxxcoin RPC API.
package ethclient
...
// Client defines typed wrappers for the Daxxcoin RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, daxxcoin.NotFound
	}
...
func (ec *Client) SyncProgress(ctx context.Context) (*daxxcoin.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (daxxcoin.Subscription, error) {
	return ec.c.EthSubscribe(ctx, ch, "newHeads", map[string]struct{}{})
}

// State Access

// BalanceAt returns the deibalance of the given account.
...
func (ec *Client) FilterLogs(ctx context.Context, q daxxcoin.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q daxxcoin.FilterQuery, ch chan<- types.Log) (daxxcoin.Subscription, error) {
	return ec.c.EthSubscribe(ctx, ch, "logs", toFilterArg(q))
}

func toFilterArg(q daxxcoin.FilterQuery) interface{} {
...
// PendingBalanceAt returns the deibalance of the given account in the pending state.
...
func (ec *Client) CallContract(ctx context.Context, msg daxxcoin.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) PendingCallContract(ctx context.Context, msg daxxcoin.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) EstimateGas(ctx context.Context, msg daxxcoin.CallMsg) (*big.Int, error) {
	var hex hexutil.Big
...
func toCallArg(msg daxxcoin.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
