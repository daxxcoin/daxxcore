...
// MainnetChainConfig returns the chain configurations for the main Daxxcoin network.
...
// MainnetGenesis returns the JSON spec to use for the main Daxxcoin network. It
// is actually empty since that defaults to the hard coded binary genesis block.
func MainnetGenesis() string {
	return ""
}

// TestnetChainConfig returns the chain configurations for the Daxxcoin test network.
...
// TestnetGenesis returns the JSON spec to use for the Daxxcoin test network.
