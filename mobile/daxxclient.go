...
// Contains a wrapper for the Daxxcoin client.
...
// DaxxcoinClient provides access to the Daxxcoin APIs.
type DaxxcoinClient struct {
	client *ethclient.Client
}

// NewDaxxcoinClient connects a client to the given URL.
func NewDaxxcoinClient(rawurl string) (client *DaxxcoinClient, _ error) {
	rawClient, err := ethclient.Dial(rawurl)
	return &DaxxcoinClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *DaxxcoinClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *DaxxcoinClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *DaxxcoinClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *DaxxcoinClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *DaxxcoinClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *DaxxcoinClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *DaxxcoinClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *DaxxcoinClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *DaxxcoinClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *DaxxcoinClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
// GetBalanceAt returns the deibalance of the given account.
// The block number can be <0, in which case the balance is taken from the latest known block.
func (ec *DaxxcoinClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *DaxxcoinClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *DaxxcoinClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *DaxxcoinClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *DaxxcoinClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *DaxxcoinClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
// GetPendingBalanceAt returns the deibalance of the given account in the pending state.
func (ec *DaxxcoinClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *DaxxcoinClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *DaxxcoinClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *DaxxcoinClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *DaxxcoinClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *DaxxcoinClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *DaxxcoinClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *DaxxcoinClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *DaxxcoinClient) EstimateGas(ctx *Context, msg *CallMsg) (gas *BigInt, _ error) {
...
func (ec *DaxxcoinClient) SendTransaction(ctx *Context, tx *Transaction) error {
