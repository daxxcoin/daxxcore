...
// Package types contains data types related to Daxxcoin consensus.
package types
...
// Header represents a block header in the Daxxcoin blockchain.
type Header struct {
...
// Block represents an entire block in the Daxxcoin blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the Daxxcoin
...
// EncodeRLP serializes b into the Daxxcoin RLP block format.
