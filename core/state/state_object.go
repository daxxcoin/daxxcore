...
// StateObject represents an Daxxcoin account which is being modified.
//
...
type StateObject struct {
	address common.Address // Daxxcoin address of this account
	data    Account
	db      *StateDB
...
// Account is the Daxxcoin consensus representation of accounts.
