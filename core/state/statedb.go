...
// Package state provides a caching layer atop the Daxxcoin state trie.
package state
...
// StateDBs within the daxxcoin protocol are used to store anything
...
//
// Carrying over the balance ensures that daxxcoindoesn't disappear.
