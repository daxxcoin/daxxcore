...
// Package accounts implements high level Daxxcoin account management.
package accounts
...
// Account represents an Daxxcoin account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Daxxcoin account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain daxxcoin.ChainStateReader)
