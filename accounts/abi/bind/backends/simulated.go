...
type SimulatedBackend struct {
	...
	blockchain *core.BlockChain // Daxxcoin blockchain to handle the consensus
...
// BalanceAt returns the deibalance of a certain account in the blockchain.
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call daxxcoin.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call daxxcoin.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call daxxcoin.CallMsg) (*big.Int, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContract(ctx context.Context, call daxxcoin.CallMsg, block *types.Block, statedb *state.StateDB) ([]byte, *big.Int, error) {
