...
// Package bind generates Daxxcoin contract Go bindings.
//
// Detailed usage document and tutorial available on the daxxcoreWiki page:
// https://github.com/daxxcoin/daxxcore/wiki/Native-DApps:-Go-bindings-to-Daxxcoin-contracts
package bind
