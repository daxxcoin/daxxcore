...
[![Build
Status](https://travis-ci.org/daxxcoin/daxxCore.png?branch=master)](https://travis-ci.org/daxxcoin/daxxCore)

The common package contains the daxxcoin utility library.

# Installation

As a subdirectory the main daxxcorerepository, you get it with
`go get github.com/daxxcoin/daxxcore`.

# Usage

## RLP (Recursive Linear Prefix) Encoding

RLP Encoding is an encoding scheme used by the Daxxcoin project. It
encodes any native value or list to a string.

More in depth information about the encoding scheme see the
[Wiki](http://wiki.daxxcoin.org/index.php/RLP) article.
...
Patricie Tree is a merkle trie used by the Daxxcoin project.

More in depth information about the (modified) Patricia Trie can be
found on the [Wiki](http://wiki.daxxcoin.org/index.php/Patricia_Tree).
