...
import (
	...
	"github.com/daxxcoin/daxxcore/internal/jsre"
...
func newTester(t *testing.T, confOverride func(*eth.Config)) *tester {
	...
	// Create a networkless protocol stack and start an Daxxcoin service within
	...
	ethConf := &eth.Config{
		...
		Daxxcoinbase:   common.HexToAddress(testAddress),
		PowTest:     true,
	}
	if confOverride != nil {
	...
	if err = stack.Register(func(ctx *node.ServiceContext) (node.Service, error) { return eth.New(ctx, ethConf) }); err != nil {
		t.Fatalf("failed to register Daxxcoin protocol: %v", err)
	}
