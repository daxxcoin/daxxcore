...
import (
	...
	"github.com/daxxcoin/daxxcore/whisper"
)
...
func main() {
	...
	// Create an Daxxcoin peer to communicate through
	server := p2p.Server{
		PrivateKey: key,
		MaxPeers:   10,
		Name:       name,
	...
	fmt.Println("Starting Daxxcoin peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start Daxxcoin peer: %v.\n", err)
		os.Exit(1)
	}
