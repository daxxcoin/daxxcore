...
import (
	...
	"github.com/daxxcoin/daxxcore/event/filter"
...
// Whisper represents a dark communication interface through the Daxxcoin
...
// New creates a Whisper client ready to communicate through the Daxxcoin P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
